...
**v-clappr** (`v-clappr`) -- Vue.js wrapper for Clappr media player.
...
|------------------------------|------|
| `vue`                        | peer |
| `@clappr/core`               | peer + runtime |
| `@clappr/hlsjs-playback`     | peer + runtime |
| `@clappr/plugins`            | peer + runtime |
